...
const Help = () => {
    ...
    return (
        <>
            <button onClick={toggle} className="fixed bottom-8 p-2 rounded-lg right-24 btn z-[60]">
                <Question size={48} className="fill-grey-700 hover:scale-125 block transition" />
            </button>

            <animated.div style={animation} className="flex items-center justify-center fixed top-0 left-0 right-0 bottom-0 py-8 px-4 md:px-16  bg-black/80 z-50">
                ...
                <div className="flex my-4 items-center mx-8 justify-center flex-col max-w-[200px]">
                ...
                <div className="flex my-4 items-center mx-8 justify-center flex-col max-w-[200px] w-full">
                    <CircleFill size={16} className="mr-2 fill-white animate-ping relative top-3 right-3 z-[60]" />
                    <HandIndexFill size={32} className="mb-6 -rotate-45 fill-white" />
                    <p className="text-white">Tap the right side of the screen to bounce the ball <span className="text-orange-200">RIGHT</span>.</p>
                </div>
